package com.Java_Array_Day6;
	...
	public class Reverse_Array_Quiz_Two {
...
//	-The method needs to read from the console until all the numbers are entered, and thenreturn an array containing the numbers entered.
